...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-list"></i> Semi-Final Results</h1>
    <div>
...
<?php if (empty($rankings)): ?>
    <div class="alert alert-warning">Semi-final round not completed yet.</div>
<?php else: ?>
    <div class="card">
        <div class="card-header bg-info text-white">
            <h5 class="mb-0">Semi-Final Rankings</h5>
        </div>
